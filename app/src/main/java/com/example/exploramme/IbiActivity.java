...
public class IbiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ibi);
        ...
        toolbar.setTitle(R.string.toolbar_ibi);

        // Cargar lugares desde la base de datos con filtro de ciudad (Ibi)
        cargarLugares("Ibi");
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(IbiActivity.this, AnyadirSitio.class);
