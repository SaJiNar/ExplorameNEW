...
public class CastallaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_castalla);
        ...
        toolbar.setTitle(R.string.toolbar_castalla);

        // Cargar lugares desde la base de datos con filtro de ciudad (Castalla)
        cargarLugares("Castalla");
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(CastallaActivity.this, AnyadirSitio.class);
