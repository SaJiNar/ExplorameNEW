...
public class AlcoyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alcoy);
        ...
        toolbar.setTitle(R.string.toolbar_alcoy);

        // Cargar lugares desde la base de datos con filtro de ciudad (Alcoy)
        cargarLugares("Alcoy");
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(AlcoyActivity.this, AnyadirSitio.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 1) {
            if (resultCode == RESULT_OK) {
                ...
                String telefono_lugar = data.getStringExtra("telefon_lugar");
